...
var dndLink = document.querySelector(".closeDnd"); //var accediLink = document.querySelector(".closeAccedi");
...
progettoLink.addEventListener("click", function () {
  menu.classList.remove("active");
});
dndLink.addEventListener("click", function () {
  menu.classList.remove("active");
});
...
var contactForm = document.querySelector('.contattaci');
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunkworlds_inn"] = self["webpackChunkworlds_inn"] || [];
